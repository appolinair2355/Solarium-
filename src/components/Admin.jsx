...
function AdminPanel() {
  ...
  const TG_FORMATS = [
    ...
    { value: '4',  label: '#4 — 🎰 Prédiction Standard' },
    ...
    // ── Formats renouvelés 15-25 ──────────────────────────────────────────────
    { value: '15', label: '#15 — 🌐 Globe Pro (Égalité)' },
    { value: '16', label: '#16 — 📱 SMS Sharp (Égalité compact)' },
    { value: '17', label: '#17 — ⚡ Split Fire (2+3 Cartes)' },
    { value: '18', label: '#18 — 💠 Block Badge (2/3 Cartes)' },
    { value: '19', label: '#19 — 🏛️ Marble VIP' },
    { value: '20', label: '#20 — ⚡ Thunder Strike' },
    { value: '21', label: '#21 — 🎩 Black Prestige' },
    { value: '22', label: '#22 — 📣 Live Broadcast (avec main)' },
    { value: '23', label: '#23 — 🚨 Red Siren' },
    { value: '24', label: '#24 — 🌙 Midnight Sky' },
    { value: '25', label: '#25 — 📊 Data Panel' },
    // ── Formats 26-35 : TROIS CARTES ─────────────────────────────────────────
    { value: '26', label: '#26 — 🏆 Trio Champion' },
    { value: '27', label: '#27 — 🎯 Trio Sniper' },
    { value: '28', label: '#28 — 💎 Trio Diamant' },
    { value: '29', label: '#29 — 🟣 Trio Neon' },
    { value: '30', label: '#30 — 💻 Trio Terminal' },
    { value: '31', label: '#31 — 🏅 Trio Prestige' },
    { value: '32', label: '#32 — 📱 Trio SMS' },
    { value: '33', label: '#33 — 🚀 Trio Rocket' },
    { value: '34', label: '#34 — ⚛️ Trio Atom' },
    { value: '35', label: '#35 — ✨ Trio Gold Star' },
    // ── Formats 36-45 : DEUX CARTES ──────────────────────────────────────────
    { value: '36', label: '#36 — 💪 Duo Power' },
    { value: '37', label: '#37 — 🔮 Duo Oracle' },
    { value: '38', label: '#38 — 🧲 Duo Magnet' },
    { value: '39', label: '#39 — 📡 Duo Radar' },
    { value: '40', label: '#40 — 🌊 Duo Wave' },
    { value: '41', label: '#41 — 💡 Duo Insight' },
    { value: '42', label: '#42 — 🏹 Duo Arrow' },
    { value: '43', label: '#43 — 🔔 Duo Bell' },
    { value: '44', label: '#44 — 👑 Duo Crown' },
    { value: '45', label: '#45 — ⚡ Duo Zap' },
    // ── Formats 46-55 : VICTOIRE ─────────────────────────────────────────────
    { value: '46', label: '#46 — 🏆 Win Champion' },
    { value: '47', label: '#47 — 🌟 Win Star Elite' },
    { value: '48', label: '#48 — ⚡ Win Flash' },
    { value: '49', label: '#49 — 🥇 Win Or (Gold)' },
    { value: '50', label: '#50 — 💎 Win Diamond VIP' },
    { value: '51', label: '#51 — 🔔 Win Signal' },
    { value: '52', label: '#52 — 🚨 Win Alert' },
    { value: '53', label: '#53 — 🃏 Win Compact' },
    { value: '54', label: '#54 — 🏆 Victoire Premium HTML' },
    { value: '55', label: '#55 — ◼️ Win Dark' },
    ...
    { value: '64', label: '#64 — 💎 Suit Crystal' },
    ...
    { value: '77', label: '#77 — 🌈 Absence Victoire (V1/V2)' },
  ];
