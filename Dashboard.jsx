                    ...
                    {(user?.is_admin || user?.is_premium) && (
                      <div className="absence-counter-chip">
                        ...
                        {absences.length === 0 ? (
                          ...
                          // ── Mode Compteurs 3 — C2 / C3 / C4 ─────────────────────────
                          if (a.isCompteurAbsences) {
                            const c2     = a.c3_abs       || 0;
                            ...
                            if (blocked) {
                              ...
                              if (c3 >= S3) {
                                signal = { text: `→ Prédit ${a.display} (manquant)`, color: '#f59e0b' };
                              } else {
                                signal = { text: `→ Prédit ${inv} (inverse)`, color: '#22c55e' };
                              }
                            }
